...
Active learning, teaching, social learning, speed of processing
...
\item {\bf MacDonald, K.}, \& Frank, M.C. (under review). When does passive learning improve the effectiveness of active learning?
...
\item {\bf MacDonald, K.}, LaMarr, T., Corina, D., Marchman V.A., \& Fernald, A. (in prep). Age-related changes in real-time American Sign Language comprehension.
